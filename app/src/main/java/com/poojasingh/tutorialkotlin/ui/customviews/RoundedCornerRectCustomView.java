...
public class RoundedCornerRectCustomView extends View{
    ...
    public RoundedCornerRectCustomView(Context context) {
        super(context);
        init();
    }

    public RoundedCornerRectCustomView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public RoundedCornerRectCustomView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        baseBarPaint.setColor(Color.parseColor("#48ea8b"));
